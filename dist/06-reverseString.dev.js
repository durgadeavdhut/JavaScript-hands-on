...
function reverseStringIgnoreSpaces(str) {
  var result = ""; // To store reversed string without spaces
  // Loop from the end of the string to the start

  for (var i = str.length - 1; i >= 0; i--) {
    var ch = str.charAt(i); // Get character at position i
...
var s2 = "Soon I will be Angular IT Champ"; // Invoke function and log output
